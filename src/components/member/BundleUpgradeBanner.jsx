...
export default function BundleUpgradeBanner({ ownedKeys }) {
  ...
  return (
    <section
      className="relative overflow-hidden rounded-2xl border border-yellow-400/35 bg-gradient-to-e from-yellow-400/15 via-black/40 to-black/60 p-5 md:p-6"
      aria-label={t("member.upgradeAria")}
    >
      <Glow className="-top-10 -end-10 bg-yellow-400/10" />
      <Glow className="-bottom-8 -start-8 bg-emerald-400/10" />
      ...
      <div className="relative flex flex-col md:flex-row md:items-center gap-4 md:gap-6">
        ...
        <Link
          ...
          className="w-full md:w-auto flex-shrink-0 inline-flex items-center justify-center gap-2 bg-yellow-400 text-black font-black text-sm px-6 py-3.5 rounded-xl hover:bg-yellow-300 transition-colors shadow-lg shadow-yellow-400/20 min-h-[48px] text-center"
        >
