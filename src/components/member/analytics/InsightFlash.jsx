    ...
    <AnimatePresence mode="wait">
      {insight && (
        <motion.div
          ...
          className="relative overflow-hidden rounded-xl border border-yellow-400/35 bg-gradient-to-e from-yellow-400/15 via-[#0a0e14] to-black/95 p-3.5 sm:p-4 shadow-md shadow-yellow-400/5"
          role="status"
          aria-live="polite"
        >
          <div
            className="absolute -top-6 -start-6 w-20 h-20 rounded-full bg-yellow-400/10 blur-2xl pointer-events-none"
            aria-hidden
          />
          <div className="relative flex items-start gap-3">
            ...
            <div className="flex-1 min-w-0 pe-1">
              <p className="text-yellow-100 font-black text-sm leading-snug">{insight.title}</p>
