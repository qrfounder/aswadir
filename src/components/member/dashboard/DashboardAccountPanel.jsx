...
export default function DashboardAccountPanel({
  ...
  return (
    <div className="space-y-5 sm:space-y-6">
      ...
      <section className="dark-card rounded-2xl p-5 sm:p-6 border border-yellow-400/15 space-y-3">
        <h2 className="text-white font-black text-base flex items-center gap-2">
          <HelpCircle className="w-5 h-5 text-yellow-400" aria-hidden />
        ...
        <div className="flex flex-col sm:flex-row flex-wrap gap-2 pt-1">
          <Link
            to="/#faq"
            className="inline-flex items-center justify-center gap-2 px-4 py-2.5 rounded-xl border border-yellow-400/30 text-yellow-200 text-sm font-bold hover:bg-yellow-400/10 transition-colors"
          >
