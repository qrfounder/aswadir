  ...
  return (
    <div className="min-h-screen bg-background overflow-x-hidden">
      ...
      <main className="pb-28 md:pb-16">
            ...
            <div className="grid lg:grid-cols-2 gap-10 items-center">
              ...
              <div className="order-2 lg:order-1 space-y-6">
                ...
                <div className="inline-flex items-center gap-2 bg-brand/10 border border-brand/30 rounded-full px-4 py-2">
                  ...
                  <span className="text-brand text-sm font-bold">{t("social.users")}</span>
                </div>
              ...
              <div className="order-1 lg:order-2 space-y-3">
                <div className="relative rounded-2xl overflow-hidden border border-brand/20 glow-gold">
                  <img
                ...
                <div className="flex gap-2">
                  {productGallery.map((item, i) => (
                    <button
                      ...
                      className={`flex-1 flex flex-col gap-1 min-w-0 rounded-lg focus:outline-none focus-visible:ring-2 focus-visible:ring-primary/80 ${
                        activeImage === i ? "ring-2 ring-primary/60 rounded-lg" : ""
                      }`}
                    >
                      <span
                        className={`block rounded-lg overflow-hidden border-2 transition-all ${
                          activeImage === i ? "border-brand/25" : "border-gray-700"
                        }`}
                      >
        ...
        {/* ─── SOCIAL PROOF BAR ─── */}
        <section className="py-6 px-4 bg-black/30 border-y border-brand/10">
        ...
        <section className="py-16 px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="rounded-2xl overflow-hidden border border-brand/20 glow-gold max-w-2xl mx-auto">
              <img
          ...
          <div className="max-w-5xl mx-auto">
            <div className="grid md:grid-cols-3 gap-4">
              {[
                ...
                <div key={i} className="rounded-xl overflow-hidden border border-brand/10">
        ...
        <section className="py-16 px-4">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-10">
              <div className="inline-flex items-center gap-2 bg-brand/10 border border-brand/30 rounded-full px-4 py-2 mb-4">
                <Award className="w-4 h-4 text-primary" />
                <span className="text-brand text-sm font-bold">{t("testimonials.pillBadge")}</span>
              </div>
      ...
      {/* Footer */}
      <footer className="bg-black/50 border-t border-brand/10 py-8 px-4 text-center">
          ...
          <div className="max-w-lg mx-auto space-y-2.5">
            <div className="flex flex-wrap items-center justify-center gap-x-3 gap-y-1 text-[10px] sm:text-xs text-gray-400">
              <span className="inline-flex items-center gap-1">
                <span className="text-success">✓</span> {t("landing.stickyGuarantee")}
              </span>
              <span className="inline-flex items-center gap-1">
                <span className="text-success">✓</span> {t("landing.stickySecure")}
              </span>
              <span className="inline-flex items-center gap-1">
                <span className="text-success">✓</span> {t("landing.stickyInstant")}
              </span>
            </div>
